...
namespace DAL.mapper.concrete
{
    ...
    class CourseMapper : AbstracMapper<Course, int?, List<Course>>, ICourseMapper
    {
        ...
        internal List<Student> LoadStudents(Course c)
        {
        ...
        protected override Course Map(IDataRecord record)
        {
            ...
            return new CourseProxy(c,context);
        }

        public override Course Create(Course entity)
        {
            return new CourseProxy(base.Create(entity),context);
        }

        public override Course Update(Course entity)
        {
            return new CourseProxy(base.Update(entity), context);
        }
